...
<head>
    ...
    <title>Regional Matrimony Admin Portal</title>
    ...
    <link href="<c:url value="resources/assets/css/cs-skin-elastic.css" />" rel="stylesheet">
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="${urlGroom}"> <i class="menu-icon fa fa-male"></i>Register Groom</a>
                    </li>
					<li>
                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="resources/images/avatar/4.jpg"></span>
                                    <div class="message media-body">
    ...
    <script type="text/javascript" src="resources/assets/js/init/weather-init.js"></script>

    <script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
    <script type="text/javascript" src="resources/assets/js/init/fullcalendar-init.js"></script>
